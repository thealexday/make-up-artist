...
const cardsDescription = [
    ...
    },
    {
        ...
        description: 'Макияж любой сложности от нежного нюдового до цветного со стразами и стрелками. Реснички пучки входят в стоимость. Помогу подобрать вид собранной прически (хвост, пучок, может быть как гладким, так и собранным из локонов).',
        buttonText: 'НАЗАД'
    },
    {
        id: 4,
